...
public class EmailCampaignServiceImpl implements EmailCampaignService {
    ...
    public EmailCampaignServiceImpl(EmailCampaignRepository campaignRepository, JavaMailSender mailSender) {
    ...
    @Override
    public EmailCampaign recordCampaign(Long templateId, Long emailListId, String subject, String htmlContent, EmailList emailList) throws MessagingException {
